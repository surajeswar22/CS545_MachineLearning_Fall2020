...
class Optimizers():
    ...
    def sgd(self, error_f, gradient_f, fargs=[],
            n_epochs=100, learning_rate=0.001, save_wtrace=False,
            error_convert_f=lambda err: err, verbose=True):
        '''
...
error_convert_f: function that converts the standardized error from error_f to original T units.
    ...
    def adam(self, error_f, gradient_f, fargs=[],
...
error_convert_f: function that converts the standardized error from error_f to original T units.
    ...
    def scg(self, error_f, gradient_f, fargs=[],
            n_epochs=100, learning_rate=None, save_wtrace=False,
            error_convert_f=lambda err: err, verbose=True):
